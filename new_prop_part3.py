# cette fichier pour test sur 1seul lien avec parcoure nombre page exact
import scrapy
import json
...
class PropiedadesSpider(scrapy.Spider):
    name = 'new_propiedades_spider_part3'
    ...
    def start_requests(self):
        ...
        list_Referer=[
                        ...
                        #----------type=3 dans le format--------------------------------------
                        'https://propiedades.com/df/industrial-',
                        'https://propiedades.com/aguascalientes/industrial-',
                        'https://propiedades.com/norte-mexicali/industrial-',
                        'https://propiedades.com/baja-california-sur/industrial-',
                        'https://propiedades.com/campeche/industrial-',
                        'https://propiedades.com/coahuila/industrial-',
                        'https://propiedades.com/colima/industrial-',
                        'https://propiedades.com/chiapas/industrial-',
                        'https://propiedades.com/chihuahua/industrial-',
                        'https://propiedades.com/durango/industrial-',
                        'https://propiedades.com/guanajuato/industrial-',
                        'https://propiedades.com/guerrero/industrial-',
                        'https://propiedades.com/hidalgo/industrial-',
                        'https://propiedades.com/jalisco/industrial-',
                        'https://propiedades.com/estado-de-mexico-el-tambor-naucalpan-de-juarez/industrial-',
                        'https://propiedades.com/michoacan/industrial-',
                        'https://propiedades.com/morelos/industrial-',
                        'https://propiedades.com/nayarit/industrial-',
                        'https://propiedades.com/nuevo-leon/industrial-',
                        'https://propiedades.com/oaxaca/industrial-',
                        'https://propiedades.com/puebla/industrial-',
                        'https://propiedades.com/queretaro/industrial-',
                        'https://propiedades.com/quintana-roo/industrial-',
                        'https://propiedades.com/san-luis-potosi/industrial-',
                        'https://propiedades.com/sinaloa/industrial-',
                        'https://propiedades.com/sonora/industrial-',
                        'https://propiedades.com/tabasco/industrial-',
                        'https://propiedades.com/tamaulipas/industrial-',
                        'https://propiedades.com/tlaxcala/industrial-',
                        'https://propiedades.com/veracruz/industrial-',
                        'https://propiedades.com/yucatan/industrial-',
                        'https://propiedades.com/zacatecas/industrial-',
